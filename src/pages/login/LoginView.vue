    ...
    <div class="login-card">
      ...
      <form @submit.prevent="handleSubmit" id="login-form">
        ...
        <div v-if="isRegister" class="form-field">
          <select v-model="role" style="width: 100%; height: 44px; border: 1px solid #d9d9d9; border-radius: 4px; padding: 0 14px; font-size: 15px;">
        ...
        <p class="login-msg" :style="{ color: msgBox.includes('成功') ? '#52c41a' : '#f5222d' }">
          {{ msgBox }}
        </p>
      </form>
...
<style scoped>
/* 此处保留你发给我的 LoginView.vue 原有全部 CSS */
